...
const DEBIT_NOTE =
  "Внимание: Оформляйте только один продукт на выбор — либо Дебетовую карту ВТБ, либо Платёжный стикер ВТБ. При одновременном оформлении обоих продуктов выплата не начисляется."
